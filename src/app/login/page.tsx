  ...
  return (
    <TubesBackground>
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-xl w-full max-w-sm">
          <h1 className="text-xl font-semibold text-gray-800 mb-1" style={{ fontFamily: 'var(--font-playfair)' }}>
            AtomQuest Portal
          </h1>
          <p className="text-gray-500 text-xs mb-5">Goal Setting & Tracking</p>
